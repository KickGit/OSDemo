package net.oschinademo.app.osdemo.base;
...
import net.oschinademo.app.osdemo.R;
import net.oschinademo.app.osdemo.util.StringUtils;
...
public class BaseApplication extends Application {
    ...
    public static void putReadedPostList(String preFileName, String key, String value) {
        SharedPreferences preferences = getPreferences(preFileName);
        int size = preferences.getAll().size();
        Editor ediotr = preferences.edit();
        if (size>=100){
            ediotr.clear();
        }
