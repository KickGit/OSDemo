package net.oschinademo.app.osdemo.api;
...
import net.oschinademo.app.osdemo.util.AppContext;
import net.oschinademo.app.osdemo.util.TLog;
...
//    private static String API_URL = "http://192.168.1.101/%s";
    ...
    public static void setUserAgent(String userAgent){client.setUserAgent(userAgent);}

    public static void setCookie(String cookie){client.addHeader("Cookie",cookie);}
